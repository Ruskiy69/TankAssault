...
*                                                               *
* Level Editor:                                                 *
* I included a simple level editor in case you want to create   *
* your own for whatever reason. It is the same one I used in    *
* the game, albeit it might be slightly out-dated, because I    *
* focus more on updating the game, not the editor.              *
* Using it is simple, 'S' switches between tiles, left-click    *
* places them, 'E' exports everything on-screen to Map.txt, 'I' *
* imports everything from Map.txt.                              *
*                                                               *
* Special Thanks:                                               *
